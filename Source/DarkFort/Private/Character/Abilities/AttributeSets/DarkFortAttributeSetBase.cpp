...
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UDarkFortAttributeSetBase, Health, OldMaxHealth);
}

void UDarkFortAttributeSetBase::OnRep_Stamina(const FGameplayAttributeData& OldStamina)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UDarkFortAttributeSetBase, Health, OldStamina);
}

void UDarkFortAttributeSetBase::OnRep_MaxStamina(const FGameplayAttributeData& OldMaxStamina)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(UDarkFortAttributeSetBase, Health, OldMaxStamina);
}
